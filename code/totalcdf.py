...
# --- 2. Data Loading ---
file_path = '/Users/fake deposit/merged_max_results.pkl'
...
# --- 6. Axis Settings ---
ax.set_xlabel('Time (ms)', fontsize=hzysfontsize, labelpad=10)
...
print(f"CDF Chart (aligned) saved to: {save_path}")